  ...
  return (
    <div className="reading-col">
      <hr
        style={{
          border: "none",
          borderTop: `1px solid ${gold ? "#B89B5E" : "#D8D3C8"}`,
          margin: "0",
        }}
      />
    </div>
    ...
    >
      ...
      <section style={{ paddingTop: "100px", paddingBottom: "80px" }}>
        <div className="reading-col">
          <div style={{ opacity: 1 }}>
            ...
            >
              To Every Consultant in Nigeria Who Wants to Genuinely Help
              Businesses Solve Problems — and Charge Premium Without Feeling
              Guilty
            </h1>
            ...
            >
              ...
              >
                Are you genuinely passionate about helping businesses and
                organizations solve real problems?
              </p>

              <p>Not just carrying the title "Consultant."</p>
              <p>Not just giving opinions.</p>
              <p>
                Not just telling business owners what you think they should do.
              </p>
              <p>
                But actually being able to sit with a difficult business
                problem, break it down, find what is really causing it, and
                recommend a solution the business can act on.
              </p>
              <p>
                If your answer is yes, then you may have just found one of the
                most useful resources you'll come across today.
              </p>
              <p>
                But if you simply like the title "Consultant" more than the
                responsibility that comes with it, you can stop reading here.
              </p>
              <p style={{ fontWeight: 600 }}>
                Because this is for the consultant who wants to become genuinely
                valuable.
              </p>

              <p>
                The consultant who wants clients to look at their
        ...
        <div className="reading-col">
          <FadeIn>
            ...
            >
              ...
              >
                Take complex business knowledge and turn it into practical ideas
                that people can actually use.
              </p>

              <p>
                We bring together business concepts, frameworks, experiences,
                and practical lessons and distill them into simple tools you can
                understand and apply.
              </p>
              <p>
                So you are not simply taking one person's opinion and hoping it
                works. You're learning practical ways of thinking that have been
                used across different areas of business and problem-solving.
              </p>
              <p>
                And recently, we put these ideas into a book created for people
                like you.
              </p>
            </div>
          </FadeIn>
      ...
      >
        <div className="reading-col">
          <FadeIn>
            ...
            >
              <p>
                We created a book that teaches consultants and business owners
                how to approach business problems systematically.
              </p>
              ...
              >
                "Here is what is actually happening, here is why it is
                happening, and here is what we should do about it."
              </p>
            </div>
                ...
                >
                  <img
                    ...
                    style={{
                      ...
                      boxShadow:
                        "8px 16px 40px rgba(0,0,0,0.25), 2px 4px 12px rgba(0,0,0,0.15)",
      ...
      <section style={{ paddingTop: "80px", paddingBottom: "80px" }}>
        <div className="reading-col">
          <FadeIn>
            ...
            >
              A complete system for thinking through, diagnosing, and solving
              any business problem — with clarity and confidence.
            </p>
          </FadeIn>
          ...
          <FadeIn>
            ...
            >
              <p>
                And then you'll see the entire system applied from beginning to
                end to three real business problems, so you can see how the
                thinking works in practice — not just read about it in theory.
              </p>
              <p>
                You'll also discover when you should use the full
                problem-solving process — and when a simple shortcut is enough.
              </p>
              <p>
                Plus, the common traps that even trained consultants fall into —
                so you can recognize them before they weaken your
                recommendations.
              </p>
              <p>And finally...</p>
              <p
              ...
              >
                You'll have a repeatable way to approach whatever business
                problem comes next.
              </p>
              <p>
                Because the goal isn't for you to memorize a collection of
                frameworks. The goal is for you to develop a way of thinking
                that helps you walk into a business problem and know what to do
                next.
              </p>
            </div>
          </FadeIn>
      ...
      >
        <div className="reading-col">
          <FadeIn>
            ...
            >
              If you're serious about becoming better at solving business
              problems, I don't want to just give you the guide and leave you to
              figure out the rest yourself. That's why I'm adding these bonuses
              to your download.
            </p>
          </FadeIn>
          ...
          <FadeIn>
            ...
            >
              ...
              <p>
                You're not just getting a book. You're getting a practical
                problem-solving toolkit you can return to whenever you encounter
                a difficult business problem.
              </p>
              <p style={{ fontWeight: 600 }}>
                And the best part? These bonuses are included FREE with your
                guide.
              </p>
              <p>
                So you can start applying what you've learned instead of simply
              ...
              >
                Your next business problem could be the first one you solve
                differently.
              </p>
            </div>
          </FadeIn>
        ...
        <div className="reading-col">
          <FadeIn>
            ...
            >
              ...
              >
                Read It. Apply It. If You Don't Find It Valuable, Ask for Your
                Money Back.
              </h2>
              <div
                style={{
              ...
              >
                <p>
                  ...
                  can give you practical ways to approach business problems more
                  systematically.
                </p>
                <p>
                  But I don't want you to feel like you're taking a blind risk.
                </p>
                <p>
                  Go through the guide. Study the frameworks. Work through the
                  examples. Use the tools.
                </p>
                <p style={{ fontWeight: 600 }}>
                  If you genuinely go through the material and feel that you
                  didn't get the practical value you expected from it, simply
                  let us know within 7 days of your purchase. We'll give you
                  your money back. No long arguments. No trying to convince you.
                </p>
              </div>
            </div>
          </FadeIn>
        ...
        <div className="reading-col">
          <FadeIn>
            ...
            >
              <p>Let's be honest.</p>
              <p>
                You've probably read enough business books, watched enough
                videos, and saved enough resources to know that "I'll do it
                later" can easily become "I never did it."
              </p>
              <p>
                And that's exactly what I don't want to happen with this guide.
              </p>
              <p>
                Because the next time a business owner comes to you with a
              ...
              >
                ...
                >
                  ...
                  <p style={{ fontSize: "17px", lineHeight: 1.7, margin: 0 }}>
                    Continue relying on instinct, experience, and whatever comes
                ...
                >
                  ...
                  >
                    Have a practical system for breaking the problem down and
              ...
              <p>
                That's why if you've been thinking, "I'll get the guide later" —
              ...
              >
                The question isn't whether you'll face another business problem.
                You will. The question is whether you'll be better prepared when
                it comes.
              </p>
            </div>
          </FadeIn>
      ...
      >
        <div className="reading-col">
          <FadeIn>
            ...
            >
              <p>
                Think about what it could cost a business when you give the
                wrong advice. A business owner could spend months chasing the
                wrong problem. Thousands of naira could be wasted on the wrong
                marketing strategy. And sometimes, a consultant can lose the
                confidence of a client simply because the recommendation wasn't
                properly thought through.
              </p>
              <p>
                The ability to think through business problems systematically is
                valuable. And that's exactly what you're getting here.
              </p>
              ...
              <p>
                If you were to pay separately for professional training on all
                these areas, the cost could quickly run into tens or even
                hundreds of thousands of naira. But you don't have to.
              </p>
            </div>
            ...
            >
              ...
              >
                You're not buying another book you'll read once and forget.
                You're investing in a practical system you can keep coming back
                to.
              </p>
          ...
          <FadeIn>
            ...
            >
              {[
                {
                  step: "STEP 1",
                  action: "Click the button below and place your order.",
                },
                {
                  step: "STEP 2",
                  action:
                    "Complete your payment using the available payment option, you will be redirected to your download page.",
                },
                {
                  step: "STEP 3",
                  action: "Get instant access to your guide and bonuses.",
                },
              ].map((s, i) => (
                <div
                  key={i}
            ...
            >
              That's it. You can start learning and applying the system
              immediately.
            </p>
      ...
      <section style={{ paddingTop: "100px", paddingBottom: "100px" }}>
        <div className="reading-col">
          <FadeIn>
            ...
            >
              <p>
                You started reading this because you want to become better at
                helping businesses solve real problems. Don't lose sight of
                that.
              </p>
              <p>
                The goal isn't to become the consultant who has the fanciest
                title. It's not to impress clients by throwing complicated
                business terminology around. And it's certainly not about having
              ...
              >
                It's about becoming the person who can walk into a difficult
                business situation, make sense of what is happening, identify
                what really matters, and help the business decide what to do
                next.
              </p>
              ...
              <p style={{ fontWeight: 600, fontSize: "20px" }}>
                Get your copy of Think Like a Consultant today.
              </p>
            </div>
        ...
        <div className="reading-col">
          ...
          <FadeIn>
            <div style={{ paddingTop: "48px", maxWidth: "600px" }}>
              ...
              >
                <p>
                  If you skipped straight to the bottom of this page, let me
                ...
                <p>
                  ...
                  is designed to help you stop approaching business problems
                  with guesswork and start approaching them with a repeatable
                  way of thinking.
                </p>
                <p>
                  You'll learn how to break problems apart, find root causes,
                  generate options, prioritize what matters, think through
                  risks, and turn recommendations into action. Plus, you'll get
                  the additional tools and bonuses included with the offer.
                </p>
                <p>
                  And with the money back guarantee, you don't have to make the
                  decision blindly.
                </p>
                <p style={{ color: "var(--foreground)", fontWeight: 500 }}>
                  If becoming better at solving real business problems is
                  important to you, this is your opportunity to start.
                </p>
      ...
      >
        ...
        >
          ...
          >
            © {new Date().getFullYear()} Quick Learn Plus · Think Like a
            Consultant
          </p>
        </div>
      </footer>
